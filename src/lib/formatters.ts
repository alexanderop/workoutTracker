 ...
 * Returns "For Time" for fortime benchmarks.
 */
export function formatBenchmarkType(type: 'fortime', rounds: number): string {
  return `For Time (${rounds} ${rounds === 1 ? 'round' : 'rounds'})`
}
