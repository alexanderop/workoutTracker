...
export const HABIT_ICON_PRESETS = [
  ...
  { key: 'habit-walk', labelKey: 'walk' },
  { key: 'habit-bike', labelKey: 'bike' },
  { key: 'habit-swim', labelKey: 'swim' },
  { key: 'habit-strength', labelKey: 'strength' },
  { key: 'habit-stretch', labelKey: 'stretch' },
  ...
  { key: 'habit-supplement', labelKey: 'supplement' },
  { key: 'habit-sunlight', labelKey: 'sunlight' },
  { key: 'habit-shower', labelKey: 'shower' },
  { key: 'habit-teeth', labelKey: 'teeth' },
  { key: 'habit-no-smoke', labelKey: 'noSmoke' },
  { key: 'habit-no-alcohol', labelKey: 'noAlcohol' },
  { key: 'habit-no-phone', labelKey: 'noPhone' },
