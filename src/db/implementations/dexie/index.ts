...
import { createDexieNutritionRepository } from './nutrition'
...
export function createDexieRepositoryProvider(): RepositoryProvider {
  return {
    ...
    exerciseProgress: createDexieExerciseProgressRepository(database),
    ...
    nutrition: createDexieNutritionRepository(database),
  }
}
