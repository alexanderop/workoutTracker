export default {
  ...
  labels: {
    ...
    restTimerDescription:
      'Countdown shown after completing a strength set. Tap it during a workout to adjust by 15s or dismiss it early.',
    restTimerOff: 'Off',
    ariaRestTimerOff: 'No rest timer target',
    ariaRestTimerSeconds: '{seconds} second rest timer target',
  ...
  errors: {
    ...
    validationFailed: 'This file is not a valid workout tracker backup',
