---
type: Reference
title: "Feature Spec: Set Context Menu in Active Workout"
description: Migrated reference documentation from the former root documentation tree.
resource: brain/reference/plans/2026-01-16-set-context-menu.md
...
**Date:** 2026-01-16
**Status:** Implemented — `SetContextMenu.vue` is live in `src/features/workout/components/`
