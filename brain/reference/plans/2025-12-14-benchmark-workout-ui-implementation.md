---
type: Reference
title: "Benchmark Workout UI Redesign - Implementation Plan"
description: Migrated reference documentation from the former root documentation tree.
resource: brain/reference/plans/2025-12-14-benchmark-workout-ui-implementation.md
  ...
  <div class="flex flex-col items-center gap-4 px-6" aria-live="polite">
    ...
    <div class="flex flex-col items-center gap-1 min-h-[4rem]">
      ...
      <template v-else-if="splitComparison">
        ...
        <span class="text-sm font-medium" :class="isFaster ? 'text-green-500' : 'text-destructive'">
          {{ comparisonMessage }}
        </span>
      </template>
    </div>
  ...
  <div class="flex-1 flex flex-col">
    ...
    >
      ...
      <div class="pt-6 px-4 space-y-4">
        ...
        <!-- Progress bar -->
        <BenchmarkProgressBar :current="progress.current" :total="progress.totalCount" />
      </div>
