...
These files used to live under the root documentation tree. The root docs folder is intentionally removed; long-form reference material now lives here, inside the brain.

## Root References

- [Project Backlog](./BACKLOG.md)
- [How This Project Was Built](./BUILD_HISTORY.md)
- [Code Review Improvements](./CODE_REVIEW_IMPROVEMENTS.md)
- [Workout Tracker - Feature Documentation](./FEATURES.md)
...
- [UI Consistency Audit](./UI_CONSISTENCY_AUDIT.md)
- [UX/UI Improvement Report — Workout Tracker (Mobile)](./UX_UI_REVIEW_2025-12-29.md)
- [VueUse Optimization Opportunities](./VUEUSE_OPPORTUNITIES.md)
...
- [Vitest Browser Mode Implementation Plan (archived)](../_archive/vitest-browser-mode-plan.md)
- [Vitest Browser Mode Troubleshooting](./vitest-browser-troubleshooting.md)
- [Workout Block Model](./workout-block-model.md)

## Adr References

- [ADR 001: Plugin-Based Workout Architecture](./adr/001-plugin-based-workout-architecture.md)

## Agent References

- [Architecture Overview](./agent/architecture.md)
- [Composables Guide](./agent/composables.md)
- [IndexedDB Data Structure](./agent/database.md)
- [Testing Guide](./agent/testing.md)

## Blog References

- [Debugging an AI QA Agent That Never Wrote Its Report](./blog/debugging-ai-qa-agent-browser-testing.md)
- [Enforcing Clean Composable Architecture in Vue](./blog/enforcing-clean-composable-architecture-vue.md)
- [jsdom Tests Are Dead, Long Live Vitest Browser Mode](./blog/vitest-browser-mode.md)

## Plans References

- [Workout Calendar Feature Design (archived)](../_archive/2024-12-14-workout-calendar-design.md)
...
- [Benchmark Workout UI Redesign - Implementation Plan (archived)](../_archive/2025-12-14-benchmark-workout-ui-implementation.md)
- [Benchmark Workout UI Redesign (archived)](../_archive/2025-12-14-benchmark-workout-ui-redesign.md)
...
- [Code Review: repo-dexie Branch](./reviews/repo-dexie-review.md)
