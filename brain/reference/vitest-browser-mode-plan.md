---
type: Reference
title: "Vitest Browser Mode Implementation Plan"
description: Migrated reference documentation from the former root documentation tree.
resource: brain/reference/vitest-browser-mode-plan.md
tags: [reference]
    ...
    test: {
      ...
      projects: [
        // Fast unit/composable tests in jsdom
        {
          name: 'unit',
          test: {
            include: ['src/__tests__/composables/**/*.spec.ts', 'src/__tests__/unit/**/*.spec.ts'],
            environment: 'jsdom',
