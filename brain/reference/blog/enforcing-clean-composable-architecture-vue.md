---
type: Reference
title: "Enforcing Clean Composable Architecture in Vue"
description: Migrated reference documentation from the former root documentation tree.
resource: brain/reference/blog/enforcing-clean-composable-architecture-vue.md
tags: [reference, blog]
...
ESLint analyzes files in isolation. It can't count how many times an export gets imported across your codebase. Tools like [Knip](https://knip.dev) detect _unused_ exports (0 usages), but not _under-used_ ones (1 usage).
