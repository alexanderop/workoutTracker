---
type: Reference
title: "TIL: How Claude Code Executes Tools in Parallel"
description: Migrated reference documentation from the former root documentation tree.
resource: brain/reference/TIL-claude-parallel-tools.md
tags: [reference]
...
>
> **System:** _Actually executes the example as real tool calls_
>
> ```
> <result>
>   <name>Edit</name>
