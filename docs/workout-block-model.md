...
export type CardioResult  = { actualDurationSeconds; distanceMeters; avgPaceSecondsPerKm; calories; notes }
```
...
For the lighter case of adding a *field* to an existing kind, follow [TIL-adding-fields-to-block-types.md](./TIL-adding-fields-to-block-types.md) instead.
