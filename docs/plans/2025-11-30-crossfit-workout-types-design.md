...
type WorkoutBlock =
  ...
  | { kind: 'emom'; config: EmomConfig; exercises: ReadonlyArray<BlockExercise>; result: EmomResult | null }
  | { kind: 'amrap'; config: AmrapConfig; exercises: ReadonlyArray<BlockExercise>; result: AmrapResult | null }
  | { kind: 'tabata'; config: TabataConfig; exercise: BlockExercise; result: TabataResult | null }
  | { kind: 'fortime'; config: ForTimeConfig; exercises: ReadonlyArray<BlockExercise>; result: ForTimeResult | null }
```
