...
*Why it matters:* Users who view progress data have **2.3x higher retention**. Progress visualization generates **3x more repeat usage** than social features.
...
*Why it matters:* Push notifications for PRs boost **65% higher 90-day retention**. PRs are the core dopamine loop for strength athletes.
...
*Why it matters:* Both bodybuilders and CrossFitters care about their estimated maxes. Provides goal-setting framework.
...
*Why it matters:* Reddit users cite this as a top missing feature in many apps. Hevy's superset support is a key differentiator. Both bodybuilders (drop sets, supersets) and CrossFitters (EMOMs with paired movements) use these.
...
*Why it matters:* Users consistently request "better support for dedicated warmup routines." Avoids polluting PR calculations with warm-up weights.
...
*Why it matters:* Athletes need to remember form cues, grip variations, tempo notes. Currently a `notes` field exists on workouts but no per-exercise notes.
...
*Why it matters:* CrossFitters love benchmark WODs (Fran, Murph, etc.). Comparing times across attempts is core to the sport.
...
*Why it matters:* Known gap documented in CLAUDE.md. Templates only support strength blocks currently.
...
*Why it matters:* Modern training uses RPE for autoregulation. RIR (Reps In Reserve) exists but RPE is more universal.
...
*Why it matters:* Gamification increases retention. 68% of users stick with apps when they track progress regularly.
