...
- Documented the pattern in `docs/VUE_STYLE_GUIDE.md`.
...
- Custom `--profile` paths also reproduced empty `#app` mounts in this project while plain `--session` mode worked. This is documented in `docs/TIL-agent-browser-qa-gotchas.md`.
